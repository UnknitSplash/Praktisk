...
namespace Trie.Tests
{
    ...
    {
        private static Node<char> _parent = new Node<char>('a', 'a', NodeType.Root, null);

        public static IEnumerable<object[]> NodeTestData = new List<object[]>
        {
            new object[] {new Node<char>('a', 'a', NodeType.Final, _parent)},
            new object[] {new Node<char>('a', 'a', NodeType.Final, _parent), new Node<char>('b','b', NodeType.Intermediate, _parent)}
        };

        public static IEnumerable<object[]> NodeEqualityTestData = new List<object[]>
        {
            new object[] {new Node<char>('a', 'a', NodeType.Final, _parent), _parent, false},
            new object[] {new Node<char>('a', 'a', NodeType.Final, _parent), new Node<char>('b', 'b', NodeType.Intermediate, _parent), false},
            new object[] {new Node<char>('a', 'a', NodeType.Final, _parent), new Node<char>('a', 'a', NodeType.Final, _parent), true}
        };
        ...
        {
            //PREPARE
            var childNodes = nodes.Select(n => (Node<char>) n).ToArray();
            var parentNode = new Node<char>('b', 'b', NodeType.Final, _parent);
        ...
        public void Test_AddRootNode_ExceptionThrown()
        {
            ...
            //ACT & CHECK
            Assert.Throws<ArgumentException>(() => parentNode.AddNode(new Node<char>(' ', ' ', NodeType.Root, _parent)));
        }
        ...
        {
            //PREPARE
            var childNodes = nodes.Select(n => (Node<char>) n).ToList();
            var parentNode = new Node<char>('b', 'b', NodeType.Final, _parent);
        ...
        {
            //PREPARE
            _parent = new Node<char>('a', 'a', NodeType.Root, _parent);
            var parentNode = new Node<char>('b', 'b', NodeType.Final, _parent);
        ...
        {
            //PREPARE
            var node = new Node<char>(' ', ' ', NodeType.Intermediate, _parent);
            node.AddNode(new Node<char>('a', 'a', NodeType.Intermediate, _parent));
        ...
        {
            //PREPARE
            var nodeA = (Node<char>) node1;
            var nodeB = (Node<char>) node2;
            //ACT
